...
//OLD STUFF BELOW
	...
	if ( function_exists('register_sidebar') ) {
			...
			'name' => 'Twitter Feed',
			'id' => 'sidebar-twitter',
			'description' => 'Pulls twitter feed onto page',
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
	...
	// Use your own external URL logo link
		function wpc_url_login(){
			return get_site_url(); // your URL here
		}
		add_filter('login_headerurl', 'wpc_url_login');
  
	// Custom WordPress Login Logo
		function login_css() {
			wp_enqueue_style( 'login_css', get_template_directory_uri() . '/style-wp-login.css' );
		}
	...
	// Add a widget in WordPress Dashboard
		...
		echo '
			<ul>
				<li>Website: Markhill.co.uk</li>
				<li>Author: <a target="_blank" href="http://andyorvis.co.uk">Andy Orvis</a></li>
				<li>Contact: <a href="mailto:aorvis@ebuyer.com">aorvis@ebuyer.com</a></li>
			</ul>
			';
		}
		
		function wpc_add_dashboard_widgets() {
			wp_add_dashboard_widget('wp_dashboard_widget', 'Information', 'wpc_dashboard_widget_function');
		}
		...
		{
			echo '<span id="footer-thankyou">Developed by <a href="http://www.andyorvis.co.uk" target="_blank">Andy Orvis</a></span>';
			}
		add_filter('admin_footer_text', 'remove_footer_admin');
	
		// Removes WP logo in admin bar
		...
		function pa_admin_area_favicon() {
			$favicon_url = get_template_directory_uri() . '/_/img/favicon.png';
